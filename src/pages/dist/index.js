...
var Home = function () {
    ...
    var _f = react_1.useState(false), responseModel = _f[0], setResponseModel = _f[1];
    var _g = react_1.useState({ answers: [{ answer: "" }] }), answer = _g[0], setAnswer = _g[1];
    var _h = react_1.useState({}), question = _h[0], setQuestion = _h[1];
    var _j = react_1.useState(0), currentIndex = _j[0], setCurrentIndex = _j[1];
    var _k = react_1.useState(-1), currentQuestion = _k[0], setCurrentQuestion = _k[1];
    var _l = react_1.useState(false), clicked = _l[0], setClicked = _l[1];
    var _m = react_1.useState(new Array(1000).fill(false)), answerModal = _m[0], setAnswerModal = _m[1];
    var _o = react_1.useState({}), existingAnswer = _o[0], setExistingAnswer = _o[1];
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(material_1.Container, { className: "my-4 mt-20" },
            ...
            React.createElement("div", { className: "grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3" }, data.map(function (dat, i) { return (React.createElement(material_1.Box, { key: i, onClick: function () {
                    setQuestion(data[i]);
        ...
        currentQuestion >= 0 && React.createElement(material_1.Modal, { className: "flex justify-center", open: answerModal[currentQuestion], onClose: function () { return handleModalClose(currentQuestion); } },
            React.createElement(material_1.Box, { style: { overflow: "auto" }, className: "w-11/12 relative bg-white m-4 p-4 lg:px-12 h-full" },
                ...
                React.createElement("div", { className: "py-8 px-2 rounded shadow-lg border-2 border-purple-500" },
                    ...
                    question.questions.map(function (quest, j) { return (React.createElement("div", { onChange: function () { setCurrentIndex(j); setClicked(true); }, key: j, className: "p-4" },
                        React.createElement("p", { className: "text-lg whitespace-pre-line" },
                            " ",
                            quest.question,
                            " "),
