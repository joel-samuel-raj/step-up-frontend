...
var Home = function () {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        currentQuestion >= 0 && React.createElement(material_1.Modal, { style: { zIndex: 60 }, className: "flex justify-center z-10", open: answerModal[currentQuestion], onClose: function () { return handleModalClose(currentQuestion); } },
            React.createElement(material_1.Modal, { style: { zIndex: 65 }, className: "flex pt-14 justify-center z-20", open: answerModal[currentQuestion], onClose: function () { return handleModalClose(currentQuestion); } },
                React.createElement(material_1.Box, { style: { overflow: "auto", zIndex: 70 }, className: "z-30 w-11/12 relative bg-white m-4 p-4 lg:px-12 h-11/12" },
                    ...
                    React.createElement("div", { className: "py-8 px-2 rounded shadow-lg w-full border-2 border-purple-500" },
                        React.createElement("h3", { className: "text-center" },
                            ...
                            question.name,
                            " "),
                        question && question.questions && question.questions.map(function (quest, j) { return (React.createElement("div", { onChange: function () { setCurrentIndex(j); setClicked(true); }, key: j, className: "p-4" },
