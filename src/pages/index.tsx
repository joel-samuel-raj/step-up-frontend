...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      { currentQuestion >= 0 && <Modal style={{zIndex: 10}} className="flex justify-center z-10" open={ answerModal[ currentQuestion ] } onClose={ () => handleModalClose( currentQuestion ) }>
        <Modal style={{zIndex: 20}} className="flex justify-center z-20" open={ answerModal[ currentQuestion ] } onClose={ () => handleModalClose( currentQuestion ) }>
          <Box style={ { overflow: "auto", zIndex: 30 } } className="z-30 w-11/12 relative bg-white m-4 p-4 lg:px-12 h-11/12">
