...
function Navbar(_a) {
    ...
    var createUser = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1["default"].post(process.env.NEXT_PUBLIC_BACKEND_URL + "/auth/local/signin", newUser).then(function (res) {
                        console.log(res);
                        if (res.status === 280) {
                            alert(res.data);
                            return;
    ...
    var login = function () {
        return (React.createElement("div", null,
            React.createElement(material_1.Button, { className: "poppins", onClick: function () { return setModal(true); }, color: "inherit" }, "Login"),
            ...
            React.createElement(material_1.Modal, { className: "flex justify-center items-center p-4", open: forgotPassword, onClose: function () { return setForgotPassword(false); } },
                React.createElement(material_1.Box, { sx: {
                    ...
                    React.createElement("div", { className: "p-2 flex justify-center items-center w-6 h-6 cursor-pointer bg-red-500 hover:bg-red-600 rounded absolute top-2 right-2", onClick: function () { return setForgotPassword(false); } },
                        React.createElement(react_fontawesome_1.FontAwesomeIcon, { className: "text-white text-lg", icon: free_solid_svg_icons_1.faClose })),
    ...
    var logout = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(material_1.Button, { className: "poppins", onClick: function () { logoutUser(); }, color: "inherit" }, "Logout")));
    };
    return (React.createElement(React.Fragment, null,
        React.createElement(material_1.Box, { className: "mb-20 relative", sx: { flexGrow: 1 } },
            React.createElement(material_1.AppBar, null,
                React.createElement(material_1.Toolbar, null,
                    ...
                    React.createElement("h5", { onClick: function () { router_1["default"].push("/"); } }, "GCT Quiz App"),
                    React.createElement("div", { className: "absolute right-4 cursor-pointer" }, log ? logout() : login())))),
                    ...
                    React.createElement(link_1["default"], { href: "/Dashboard" },
                        React.createElement(material_1.ListItem, { className: "flex items-center justify-center", button: true },
                            React.createElement(material_1.ListItemIcon, null,
                                React.createElement("img", { className: "h-8 rounded-full object-contain", src: currentUser.profilePicture || defaultDp, alt: "" })),
                            React.createElement(material_1.ListItemText, null, " Dashboard "))),
